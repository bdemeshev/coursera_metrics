...
\hlstd{opts_chunk}\hlopt{$}\hlkwd{set}\hlstd{(}\hlkwc{cache}\hlstd{=}\hlnum{FALSE}\hlstd{,}\hlkwc{dev}\hlstd{=}\hlstr{'png'}\hlstd{,}\hlkwc{dpi}\hlstd{=}\hlnum{300}\hlstd{,}\hlkwc{echo}\hlstd{=}\hlnum{FALSE}\hlstd{,}\hlkwc{warning}\hlstd{=}\hlnum{FALSE}\hlstd{,}\hlkwc{message}\hlstd{=}\hlnum{FALSE}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
