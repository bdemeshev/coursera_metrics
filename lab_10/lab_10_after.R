...
# классический логит
# в теории максимум правдоподобия не существует 
# чем больше бета при икс, тем больше будет правдоподобия
# однако из-за ограниченной компьютерной точности R находит некоторые оценки
